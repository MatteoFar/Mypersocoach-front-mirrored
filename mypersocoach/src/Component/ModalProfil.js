      ...
      <>
        ...
        <div className={modal_profil}>
          <div className="modal_main1">
            ...
            <p>{this.props.date}{this.props.responseEnvironnement}{this.props.responseCroyance}{this.props.responseCapacite}{this.props.responseComportement}{this.props.response} </p>
