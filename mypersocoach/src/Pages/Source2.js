...
const headingIcons3 = [
  {
    image: ''
    // require("../Pages/logo_heading2.png")
  }
];
const headingTexts3 = [
  {
...
const iconProblems3 = [
  {
    icon: '',
    //require(`../Pages/logo_environment.png`),
    text: `Mon environnement`
  },
  {
    icon: '',
    //require(`../Pages/logo_behavior.png`),
    text: `Mon comportement`
  },
  {
    icon: '',
    //require(`../Pages/logo_capacity.png`),
    text: `Mes capacités`
  },
  {
    icon: '',
    
  //require(`../Pages/logo_conviction.png`),
